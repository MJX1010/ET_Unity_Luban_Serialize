namespace ET.Analyzer
{
    public static class Definition
    {
        ...
        //LubanSer
        public const string LubanSerAttributeName = "LubanSerAttribute";
        public const string LubanSerAttribute = "ET.LubanSerAttribute";
        public const string LubanSerEditorAttributeName = "LubanSerEditorAttribute";
        public const string LubanSerEditorAttribute = "ET.LubanSerEditorAttribute";
        public const string LubanSerTableAttributeName = "LubanSerTableAttribute";
        public const string LubanSerTableAttribute = "ET.LubanSerTableAttribute";
        public const string LubanSoGenericType = "LubanSo<T>";
        public const string UnityCreateAssetMenuAttribute = "UnityEngine.CreateAssetMenuAttribute";
        public const string UnityCreateAssetMenuAttributeName = "CreateAssetMenuAttribute";
    }
}
